...
# MY CONSTRAINT: Here no limits for renewables 

#def test_min_capacity_constraint_onwind(n):
#    print(n.global_constraints)
#    if 'expansion_witch_onwind' not in n.global_constraints.index:
#        n.add('GlobalConstraint', 'expansion_witch_onwind',
#            type='tech_capacity_expansion_limit', constant=485406.178, sense='>=',
#            carrier_attribute='onwind', investment_period=2020)
#    print(n.global_constraints)

#def test_min_capacity_constraint_solar(n):
#    print(n.global_constraints)
#    if 'expansion_witch_solar' not in n.global_constraints.index:
#        n.add('GlobalConstraint', 'expansion_witch_solar',
#            type='tech_capacity_expansion_limit', constant=392854.859, sense='>=',
#            carrier_attribute='solar', investment_period=2020)
#    print(n.global_constraints)

#def test_min_capacity_constraint_offwind(n):
#    print(n.global_constraints)
#    if 'expansion_witch_offwind' not in n.global_constraints.index:
#        n.add('GlobalConstraint', 'expansion_witch_offwind',
#            type='tech_capacity_expansion_limit', constant=13421.3462, sense='>=',
#            carrier_attribute='offwind-dc', investment_period=2020)
#    print(n.global_constraints)
...
def extra_functionality(n, snapshots):
    ...
    #test_min_capacity_constraint_onwind(n)
    #test_min_capacity_constraint_solar(n)
    #test_min_capacity_constraint_offwind(n)
